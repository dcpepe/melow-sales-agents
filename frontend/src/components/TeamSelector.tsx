      ...
      >
        {current ? (
          <>
            ...
            <span className="text-sm text-gray-600 hidden sm:block">{current.name.split(" ")[0]}</span>
          </>
        ) : (
          <>
            <div className="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center text-gray-400 text-[10px]">?</div>
          </>
        )}
